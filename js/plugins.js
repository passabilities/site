...
(function($) {
	...
	$("#facts").appear(function() {
		$("#number_lines_code").animateNumber({
			number: 503707	// Change to your number			
		}, 2200);
		$("#number_projects").animateNumber({
			number: 120		// Change to your number	
		}, 2200);
		$("#number_coffee").animateNumber({
			number: 1737		// Change to your number
		}, 2200);
	}, {
		accX: 0,
		accY: -150
